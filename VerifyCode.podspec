Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/apksafe/VerifyCode-iOS.git", :tag => 'v3.1.1' }
  s.requires_arc = true
  s.platform     = :ios
  s.vendored_frameworks ='Release/VerifyCode_iOS_3.1.1/VerifyCode.framework'
  s.resource     = "Resources/3.1.1/NTESVerifyCodeResources.bundle"
